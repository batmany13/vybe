...
export async function PUT(
  ...
  try {
    ...
    const updatedFields = {
      ...
      excitement_note: getString('excitement_note'),
      why_good_fit: getString('why_good_fit'),
    ...
    const dealResult = await sql`
      UPDATE deals SET 
        ...
        excitement_note = ${updatedFields.excitement_note},
        why_good_fit = ${updatedFields.why_good_fit},
